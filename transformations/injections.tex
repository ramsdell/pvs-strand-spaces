...
analysis sentences.
\begin{enumerate}
\item\label{item: var occurs} When $P[r,h,x](z,t)$ occurs in a
  formula, $x\in\vars(\prefix{\role^c(r)}{h})$.
...
\item Case of $P_0[r,h,x](z,t)$ in~$\Psi$.  Assume $\bun_1,\alpha_1\models
  ...
  \item
    ...
    $\sigma\circ\prefix{c_1}{|\ssp_1(s_1)|}=\ssp_1(s_1)$.  By
    Property~\ref{item: var occurs} in the definition of a security
    formula, $\gamma(x)\in\vars(\prefix{c_1}{h'})$.  Then
