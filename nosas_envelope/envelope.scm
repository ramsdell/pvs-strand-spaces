...
(defprotocol envelope basic
  ...
  (defrole tpm-power-on
    (vars (pcrkey skey) (current-value mesg))
    (trace
     (recv "power on")
  ...
  (defrole tpm-extend-enc
    ...
    (trace
     ...
     (send (enc "state" (hash "ex" current-value value) (hash pcrkey)))) ;; MSR rhs
    (priority (3 0))
    (uniq-orig tne)
...
(defskeleton envelope
  ...
  (defstrand tpm-create-key 2
    (pcrval (hash "ex" (hash "ex" origin-0 n) "obtain"))
    (k k) (aik aik))
  ...
  (defstrand tpm-extend-enc 5 (value "obtain")
    ...
    (pcrkey pcrkey) (esk esk-0) (tpmkey tpmkey-0))
  (defstrand tpm-quote 3 (nonce (enc v k))
    (current-value (hash "ex" (hash "ex" origin n) "refuse"))
    (pcrkey pcrkey-0) (aik aik))
  (defstrand tpm-extend-enc 5 (value "refuse")
    (current-value (hash "ex" origin n)) (tne tne-1) (tno tno-1)
    (pcrkey pcrkey-0) (esk esk-1) (tpmkey tpmkey-1))
  (precedes  ((2 6) (4 0)) ((2 6) (6 0)) ((3 1) (2 5))
    ((4 3) (1 0)) ((5 4) (4 2)) ((6 2) (0 0)) ((7 4) (6 1)))
  (priority ((5 3) 5) ((7 3) 5))
  (non-orig  pcrkey pcrkey-0 aik (invk k) (invk tpmkey) ;esk1
